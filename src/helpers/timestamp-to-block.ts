 ...
 */
export async function timestampToBlock(dataset: string, timestamp: number, maxBlock: number): Promise<number> {
 ...
 */
async function getHeadBlockWithTimestamp(dataset: string): Promise<{ number: number; timestamp: number }> {
