...
NOTE: SQD Network is the infrastructure provider. The Portal API provides access to 225+ blockchain datasets.`,
    {
      ...
      include_chains: z.boolean().optional().default(true).describe('Include chain statistics (default: true)'),
    },
    async ({ include_datasets, include_chains }) => {
      ...
      if (include_datasets) {
        ...
        ;(info as any).note =
          'Use portal_list_datasets to see all 225+ datasets, or portal_search_datasets to find specific chains'
      }
